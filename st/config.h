 ...
 */
static char *font = "Mononoki Nerd Font:pixelsize=20:antialias=true:autohinting=true";
static char *font2[] = {"JoyPixels:pixelsize=20;antialias=true:autohinting=true","Noto Sans Emoji"};
